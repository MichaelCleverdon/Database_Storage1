...
--
-- Host: localhost:3306
-- Generation Time: Oct 29, 2018 at 10:34 AM
...
INSERT INTO `animals` (`IDanimal`, `species`, `name`, `gender`, `yearBorn`, `insertedBy`, `IDcustomer`) VALUES
...
(1, '2018-06-20', 'Broken Leg. Given splint for 2 weeks', 'MichaelC', 168),
(2, '2016-02-04', 'Constipation. Given laxitaves to be given every time constipation occurs', 'MichaelC', 170),
(3, '2017-04-23', 'Tummy Troubles. Changed diet because of lactose intolerance.', 'MichaelC', 172),
(4, '2018-04-20', 'Leg Surgury. Follow up is necessary', 'MichaelC', 178),
(5, '2017-04-20', 'Ear Surgury. Need checkup but everything was looking okay', 'MichaelC', 179),
(6, '2016-04-20', 'Leg Surgury. Need physical therapy because of loss of motion', 'MichaelC', 180),
(7, '2015-05-15', 'Sprained Knee. Boot to keep knee from moving, will remove in 20 days', 'MichaelC', 169),
(8, '2015-12-24', 'Checkup. Everything looks great', 'MichaelC', 181),
(9, '2018-11-10', 'Vaccines. Measles, Mumps, Rubella', 'MichaelC', 176),
(10, '2017-03-20', 'Worms. Vaccinated', 'MichaelC', 167),
(11, '2018-07-21', 'Worms. Vaccinated', 'MichaelC', 173),
(12, '2018-09-30', 'Problems Breathing. Gave asthma medicine to owner for daily use', 'MichaelC', 175),
(13, '2017-02-27', 'Laringitis. ', 'MichaelC', 171),
(14, '2011-03-22', 'Flu. Administered flu shot', 'MichaelC', 174),
(15, '2001-02-12', 'Cut Leg. Cleaned and wrapped with gauze', 'MichaelC', 177),
...
(123, '2018-01-01', 'Very healthy for its age. Gave it a haircut.', 'Joseph M', 124),
...
(174, '2018-11-10', 'Vaccines. Rabies, Tetnis', 'MichaelC', 175),
...
(190, '2009-02-10', 'Gender Identity Problems, cant speak so I cant ask for clarification.', 'Perry K', 191),
...
ALTER TABLE `animals`
  ...
  ADD KEY `cust_ForeignKey` (`IDcustomer`);
...
ALTER TABLE `diagnosis`
  ...
  ADD KEY `animal_IDanimal_idx` (`IDanimal`);
...
--
ALTER TABLE `diagnosis`
  ADD CONSTRAINT `animal_IDanimal` FOREIGN KEY (`IDanimal`) REFERENCES `animals` (`IDanimal`) ON DELETE NO ACTION ON UPDATE NO ACTION;
